...
// tt_als_sweep_global_cpp
List tt_als_sweep_global_cpp(const arma::vec& yc, const List& cores_list, const List& basis_list, const arma::vec& lambda, const List& DtD_list, Rcpp::Nullable<Rcpp::NumericVector> weight, Rcpp::Nullable<Rcpp::IntegerVector> margin_order);
RcppExport SEXP _TTPsplines_tt_als_sweep_global_cpp(SEXP ycSEXP, SEXP cores_listSEXP, SEXP basis_listSEXP, SEXP lambdaSEXP, SEXP DtD_listSEXP, SEXP weightSEXP, SEXP margin_orderSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type yc(ycSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(tt_als_sweep_global_cpp(yc, cores_list, basis_list, lambda, DtD_list, weight, margin_order));
    return rcpp_result_gen;
END_RCPP
}
