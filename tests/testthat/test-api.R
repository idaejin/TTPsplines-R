test_that("lambda scalar expands and anisotropic validates", {
  ...
  expect_equal(parse_lambda_spec("CV", d = 2)$method, "CV")
  expect_true(parse_lambda_spec("cv", d = 3)$automatic)
  expect_error(parse_lambda_spec("cFS", d = 2))
  expect_error(parse_lambda_spec("cREML", d = 2))
